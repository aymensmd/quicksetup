...
class CanvAscii {
  ...
  async init() {
    try {
      await (document.fonts as any).load('600 200px "IBM Plex Mono"');
      await (document.fonts as any).load('500 12px "IBM Plex Mono"');
    } catch (e) {
  ...
  onMouseMove(evt: MouseEvent | TouchEvent) {
    ...
    const x = (e as any).clientX - bounds.left;
    const y = (e as any).clientY - bounds.top;
    this.mouse = { x, y };
  }
  ...
  render() {
    ...
    this.updateRotation();
    if (this.filter && this.scene && this.camera) {
