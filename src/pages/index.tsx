...
const projects = [
  {
    ...
    description: "Role-based access, service-layer workflows, and performance tuning across CRM modules",
    image: "/assets/erp.png",
    href: "#",
    date: "2025",
    tech: ["React", "TypeScript", "PostgreSQL", "RBAC"],
    role: "Full-Stack Developer & Architect",
    results: ["50% faster indexing", "Granular access control", "Modular service layer"],
    status: "Completed",
  },
  {
    title: "TEEMO ERP v2",
    description: "Visual workflow engine with encrypted internal messaging and financial automation",
    image: "/assets/build-an-erp-triggered-slack-alert-workflow_tmbyW7Q4.mp4",
    href: "#",
    date: "2024 - 2025",
    tech: ["Laravel", "React", "PostgreSQL", "Redis", "AI/LLM"],
    role: "Full-Stack Developer",
    results: ["Visual workflow orchestration", "E2EE messaging", "Automated finance modules"],
    status: "Completed",
  },
  {
    title: "COMUNIK CRM",
    description: "Employee, project, and scheduling workspace with integrated QA visibility",
    image: "/assets/IMG_6940.png",
    href: "#",
    date: "2024",
    tech: ["React", "Node.js", "PostgreSQL", "CI/CD"],
    role: "Frontend & Product Engineer",
    results: ["Unified employee profiles", "Project timeline planning", "Integrated test-result panel"],
    status: "Completed",
  },
  {
    title: "EVENTZELLA",
    description: "BI dashboard for event budgeting and decision support with KPI-focused charts",
    image: "/assets/ce.png",
    href: "#",
    date: "2024",
    tech: ["Vue.js", "Node.js", "MongoDB", "D3.js"],
    role: "Data Visualization Engineer",
    results: ["Budget decision support", "Interactive BI charts", "Operational forecasting views"],
    status: "Completed",
  },
];
